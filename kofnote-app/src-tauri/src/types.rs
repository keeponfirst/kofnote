...
fn prompt_profiles_dir(central_home: &Path) -> PathBuf {
    central_home.join("prompts").join("profiles")
}

fn prompt_templates_dir(central_home: &Path) -> PathBuf {
    central_home.join("prompts").join("templates")
}

pub(crate) fn list_prompt_profiles(central_home: String) -> Result<Vec<PromptProfile>, String> {
    let home = normalized_home(&central_home)?;
...
pub(crate) fn upsert_prompt_profile(central_home: String, profile: PromptProfile) -> Result<PromptProfile, String> {
    let home = normalized_home(&central_home)?;
    let dir = prompt_profiles_dir(&home);
...
pub(crate) fn delete_prompt_profile(central_home: String, id: String) -> Result<(), String> {
    let home = normalized_home(&central_home)?;
...
pub(crate) fn list_prompt_templates(central_home: String) -> Result<Vec<PromptTemplate>, String> {
    let home = normalized_home(&central_home)?;
...
pub(crate) fn upsert_prompt_template(central_home: String, template: PromptTemplate) -> Result<PromptTemplate, String> {
    let home = normalized_home(&central_home)?;
    let dir = prompt_templates_dir(&home);
    fs::create_dir_all(&dir).map_err(|e| e.to_string())?;
...
pub(crate) fn delete_prompt_template(central_home: String, id: String) -> Result<(), String> {
    let home = normalized_home(&central_home)?;
...
pub(crate) fn run_prompt_service(central_home: String, request: PromptRunRequest) -> Result<PromptRunResponse, String> {
    let home = normalized_home(&central_home)?;
